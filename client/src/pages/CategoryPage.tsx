        ...
        {hasActiveFilters && (
          <div className="mt-3 flex flex-wrap gap-2">
            {activeFilters.brand.map(brand => (
              <Badge key={`brand-${brand}`} variant="secondary" className="gap-1 flex items-center">
                Brand: {brand}
                <button 
            ...
            {activeFilters.price.map(price => (
              <Badge key={`price-${price}`} variant="secondary" className="gap-1 flex items-center">
                Price: ${price.replace('-∞', '+')}
                <button 
            ...
            {activeFilters.rating && (
              <Badge variant="secondary" className="gap-1 flex items-center">
                ...
                <button 
                  onClick={() => removeFilter('rating', activeFilters.rating as number)}
                  className="ml-1 rounded-full hover:bg-gray-200 p-0.5"
                >
                  <XIcon className="h-3 w-3" />
                </button>
            ...
            {activeFilters.discount.map(discount => (
              <Badge key={`discount-${discount}`} variant="secondary" className="gap-1 flex items-center">
                Discount: {discount}%
                <button 
            ...
            {activeFilters.shipping.map(shipping => (
              <Badge key={`shipping-${shipping}`} variant="secondary" className="gap-1 flex items-center">
                {shipping} Shipping
                <button 
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className={`${showMobileFilters ? 'block' : 'hidden'} md:block md:w-1/4 lg:w-1/5`}>
          <div className="border rounded-md bg-white overflow-hidden">
              ...
              <div className="space-y-1.5">
                {[4, 3, 2, 1].map((rating) => (
                  <div 
                    ...
                    onClick={() => setRatingFilter(activeFilters.rating === rating ? null : rating)}
                  >
            ...
            {/* Price Range Filter */}
            <Accordion type="multiple" defaultValue={['price', 'brands', 'discount', 'delivery']}>
              <AccordionItem value="price">
                <AccordionTrigger className="px-3 py-2 text-base font-medium">Price</AccordionTrigger>
                <AccordionContent className="px-3 pb-3">
                  <div className="space-y-2">
                    ...
                    <div className="pt-2 border-t mt-3">
                      <form onSubmit={handlePriceRangeSubmit} className="space-y-2">
                        <div className="flex items-center">
              ...
              <AccordionItem value="brands">
                <AccordionTrigger className="px-3 py-2 text-base font-medium">Brands</AccordionTrigger>
                <AccordionContent className="px-3 pb-3">
                  <div className="space-y-2 max-h-48 overflow-y-auto">
                    {allBrands.map((brand, index) => (
                      <div className="flex items-center" key={`brand-filter-${index}`}>
                        <Checkbox 
                          id={`brand-${index}`} 
              ...
              <AccordionItem value="discount">
                <AccordionTrigger className="px-3 py-2 text-base font-medium">Discount</AccordionTrigger>
                <AccordionContent className="px-3 pb-3">
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Checkbox 
                      ...
                      />
                      <label htmlFor="discount-10" className="ml-2 text-sm flex items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="discount-25" className="ml-2 text-sm flex items-center">
                        <PercentIcon className="h-3 w-3 mr-1 text-red-600" />
                        25% Off or more
                      </label>
                    </div>
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="discount-50" className="ml-2 text-sm flex items-center">
                        <PercentIcon className="h-3 w-3 mr-1 text-red-600" />
                        50% Off or more
                      </label>
                    </div>
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="discount-70" className="ml-2 text-sm flex items-center">
                        <PercentIcon className="h-3 w-3 mr-1 text-red-600" />
                        70% Off or more
                      </label>
                    </div>
              ...
              <AccordionItem value="delivery">
                <AccordionTrigger className="px-3 py-2 text-base font-medium">Shipping & Delivery</AccordionTrigger>
                <AccordionContent className="px-3 pb-3">
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Checkbox 
                      ...
                      />
                      <label htmlFor="shipping-free" className="ml-2 text-sm">Free Shipping</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox 
                        id="shipping-expedited" 
                        checked={activeFilters.shipping.includes('Expedited')}
                        onCheckedChange={() => toggleShippingFilter('Expedited')}
                      />
                      <label htmlFor="shipping-expedited" className="ml-2 text-sm">Expedited Shipping</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox 
                      ...
                      />
                      <label htmlFor="shipping-same-day" className="ml-2 text-sm">Same-day Delivery</label>
                    </div>
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="availability">
                <AccordionTrigger className="px-3 py-2 text-base font-medium">Availability</AccordionTrigger>
                <AccordionContent className="px-3 pb-3">
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Checkbox 
                        id="availability-instock" 
                        checked={activeFilters.availability.includes('In Stock')}
                        onCheckedChange={() => toggleAvailabilityFilter('In Stock')}
                      />
                      <label htmlFor="availability-instock" className="ml-2 text-sm">In Stock</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox 
                        id="availability-deals" 
                        checked={activeFilters.availability.includes('Deals')}
                        onCheckedChange={() => toggleAvailabilityFilter('Deals')}
                      />
                      <label htmlFor="availability-deals" className="ml-2 text-sm flex items-center">
                    ...
                    <div className="flex items-center">
                      <Checkbox 
                        ...
                        checked={activeFilters.availability.includes('B2B Prime')}
                        onCheckedChange={() => toggleAvailabilityFilter('B2B Prime')}
                      />
                      <label htmlFor="availability-prime" className="ml-2 text-sm">B2B Prime</label>
                    </div>
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <div className="hidden sm:flex border rounded overflow-hidden">
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="1" width="6" height="6" rx="1" fill={viewMode === 'grid' ? '#4B5563' : '#D1D5DB'} />
                    <rect x="9" y="1" width="6" height="6" rx="1" fill={viewMode === 'grid' ? '#4B5563' : '#D1D5DB'} />
                    <rect x="1" y="9" width="6" height="6" rx="1" fill={viewMode === 'grid' ? '#4B5563' : '#D1D5DB'} />
                    <rect x="9" y="9" width="6" height="6" rx="1" fill={viewMode === 'grid' ? '#4B5563' : '#D1D5DB'} />
                  </svg>
                </button>
                <button 
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="1" width="14" height="4" rx="1" fill={viewMode === 'list' ? '#4B5563' : '#D1D5DB'} />
                    <rect x="1" y="7" width="14" height="4" rx="1" fill={viewMode === 'list' ? '#4B5563' : '#D1D5DB'} />
                    <rect x="1" y="13" width="14" height="2" rx="1" fill={viewMode === 'list' ? '#4B5563' : '#D1D5DB'} />
                  </svg>
                </button>
              </div>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
              {filteredProducts.map((product: any) => (
                <div key={product.id} className="border rounded-md bg-white p-4 hover:shadow-md transition duration-200">
            ...
            <div className="space-y-6">
              {filteredProducts.map((product: any) => (
                <div key={product.id} className="border rounded-md bg-white p-4 hover:shadow-md transition duration-200 flex flex-col sm:flex-row gap-4">
                  <Link href={`/products/${product.id}`}>
