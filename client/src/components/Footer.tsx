    ...
    <footer className="bg-[#232f3e] text-white mt-10 pt-10 pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-700 pt-6 text-center">
          <Link href="/">
            <a className="text-2xl font-bold mb-4 inline-block">Shopperr<span className="text-[#febd69]">B2B</span></a>
          </Link>
          <div className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Shopperr B2B, Inc. All rights reserved. | Terms of Service | Privacy Policy | Cookie Settings
          </div>
        </div>
      </div>
    </footer>
